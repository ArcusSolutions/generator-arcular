...
var ControllerGenerator = yeoman.generators.NamedBase.extend({
    ...
    addFiles: function () {
        yeoman.generators.Base.prototype.template.apply(this, [
            'controller.js',
            path.join(this.env.options.appPath, 'scripts/controllers/' + this.classedName + 'Ctrl.js')
        ]);
    },
    ...
    addFileToIndex: function () {
        arcusUtils.rewriteFile({
            ...
            needle: '<!-- build:js(.) scripts/controllers.js -->',
            splicable: [
                '<script src="scripts/controllers/' + this.classedName + 'Ctrl.js"></script>'
            ]
        });
    }
});
