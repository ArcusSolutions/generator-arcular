...
var FilterGenerator = yeoman.generators.NamedBase.extend({
    ...
    addFiles: function () {
        yeoman.generators.Base.prototype.template.apply(this, [
            'directive.js',
            path.join(this.env.options.appPath, 'scripts/filters/' + this.classedName + 'Filter.js')
        ]);
    },
    ...
    addFileToIndex: function () {
        arcusUtils.rewriteFile({
            ...
            needle: '<!-- build:js(.) scripts/filters.js -->',
            splicable: [
                    '<script src="scripts/filters/' + this.classedName + 'Filter.js"></script>'
            ]
        });
    }
});
