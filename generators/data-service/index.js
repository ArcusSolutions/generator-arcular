...
var DataServiceGenerator = yeoman.generators.NamedBase.extend({
    ...
    addFiles: function () {
        yeoman.generators.Base.prototype.template.apply(this, [
            'data-service.js',
            path.join(this.env.options.appPath, 'scripts/data-services/' + this.classedName + 'DataService.js')
        ]);
    },
    ...
    addFileToIndex: function () {
        arcusUtils.rewriteFile({
            ...
            needle: '<!-- build:js(.) scripts/data-services.js -->',
            splicable: [
                '<script src="scripts/data-services/' + this.classedName + 'DataService.js"></script>'
            ]
        });
    }
});
